...
export default {
  ...
  'Load a starter plan': '스타터 계획 불러오기',
  'Choose a starter plan': '스타터 계획 선택',
  'Push / Pull / Legs': '푸시 / 풀 / 레그',
  'Mon Push · Wed Pull · Fri Legs': '월 푸시 · 수 풀 · 금 레그',
  'Upper / lower': '상체 / 하체',
  'Mon and Thu upper · Tue and Fri lower': '월·목 상체 · 화·금 하체',
  'Starter plan loaded — Mon and Thu upper · Tue and Fri lower': '스타터 계획을 불러왔습니다 — 월·목 상체 · 화·금 하체',
  'Full body': '전신',
  'Mon, Wed and Fri, a different session each day': '월·수·금, 날마다 다른 세션',
  'Starter plan loaded — Mon, Wed and Fri full body': '스타터 계획을 불러왔습니다 — 월·수·금 전신',
  '5×5': '5×5',
  'Squat, bench and row; then squat, press and deadlift. Mon A · Wed B · Fri A.': '스쿼트, 벤치, 로우. 그다음 스쿼트, 프레스, 데드리프트. 월 A · 수 B · 금 A.',
  'Starter plan loaded — Mon and Fri workout A · Wed workout B': '스타터 계획을 불러왔습니다 — 월·금 운동 A · 수 운동 B',
  'Reps left in reserve — {0} {1} more.': '반복에 여유가 있습니다 — {0} {1} 더.',
  'Every rep, but the last set was a grind — same weight again.': '횟수는 채웠지만 마지막 세트가 힘들었습니다 — 같은 무게로 한 번 더.',
  ...
  '{0} rows skipped — no exercise name.': '{0}행 건너뜀 — 운동 이름이 없습니다.',
  '{0} rows skipped — no date.': '{0}행 건너뜀 — 날짜가 없습니다.',
  '{0} rows skipped — no weight, reps, distance or time.': '{0}행 건너뜀 — 무게, 반복, 거리 또는 시간이 없습니다.',
  'Match to a library exercise': '라이브러리 운동에 연결',
  'Match to “{0}”?': '"{0}"에 연결할까요?',
  ...
  'Three working sets at a percentage of your training max: a week of 5s, a week of 3s, a 5/3/1 week, then a light week. Hit the heavy week and the max goes up.': '훈련 최대중량의 비율로 본세트 세 개: 5회 주, 3회 주, 5/3/1 주, 그다음 가벼운 주. 무거운 주를 채우면 최대중량이 올라갑니다.',
  'Week {0} of 4 — {1}% / {2}% / {3}% of a {4} {5} training max.': '4주 중 {0}주 — 훈련 최대중량 {4} {5}의 {1}% / {2}% / {3}%.',
  ...
  "The phone keeps its own log": "휴대폰이 자기 기록을 보관합니다",
  "Newest edit wins per workout day, and a day is never deleted silently.": "운동한 날마다 가장 최근 편집이 이기고, 하루가 조용히 지워지지는 않습니다.",
  "Server address": "서버 주소",
  "Sync token": "동기화 토큰",
  "Sync to my openGym": "내 openGym과 동기화",
  "Synced with your openGym": "내 openGym과 동기화했습니다",
  "Could not reach the server — the phone keeps its own log.": "서버에 연결하지 못했습니다 — 휴대폰이 자기 기록을 보관합니다.",
  "Stop syncing": "동기화 중지",
  "The log stays on this phone.": "기록은 이 휴대폰에 남습니다.",
  "Sync stopped — the log stays on this phone.": "동기화를 멈췄습니다 — 기록은 이 휴대폰에 남습니다.",
  "Sync token for the phone": "휴대폰용 동기화 토큰",
  "Sync token copied — paste it into the phone.": "토큰을 복사했습니다 — 휴대폰에 붙여넣으세요.",
  "Could not create a sync token.": "동기화 토큰을 만들지 못했습니다.",
  "Enter the server address and the sync token.": "서버 주소와 동기화 토큰을 입력하세요.",
  "Add another passkey": "패스키 하나 더 추가",
  "A second phone can sign in if you lose this one.": "이 휴대폰을 잃어버려도 다른 휴대폰으로 로그인할 수 있습니다.",
  "Passkey added": "패스키를 추가했습니다",
  "Could not add a passkey.": "패스키를 추가하지 못했습니다.",
}
