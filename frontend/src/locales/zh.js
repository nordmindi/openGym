...
export default {
  ...
  'Choose a starter plan': '选择入门计划',
  'Push / Pull / Legs': '推 / 拉 / 腿',
  'Mon Push · Wed Pull · Fri Legs': '周一推 · 周三拉 · 周五腿',
  'Upper / lower': '上肢 / 下肢',
  'Mon and Thu upper · Tue and Fri lower': '周一和周四上肢 · 周二和周五下肢',
  'Starter plan loaded — Mon and Thu upper · Tue and Fri lower': '入门计划已加载 — 周一和周四上肢 · 周二和周五下肢',
  'Full body': '全身',
  'Mon, Wed and Fri, a different session each day': '周一、周三和周五，每天一次不同的训练',
  'Starter plan loaded — Mon, Wed and Fri full body': '入门计划已加载 — 周一、周三和周五全身',
  '5×5': '5×5',
  'Squat, bench and row; then squat, press and deadlift. Mon A · Wed B · Fri A.': '深蹲、卧推和划船；然后深蹲、推举和硬拉。周一 A · 周三 B · 周五 A。',
  'Starter plan loaded — Mon and Fri workout A · Wed workout B': '入门计划已加载 — 周一和周五训练 A · 周三训练 B',
  'Reps left in reserve — {0} {1} more.': '还有余力 — 再加 {0} {1}。',
  'Every rep, but the last set was a grind — same weight again.': '次数都完成了，但最后一组很吃力 — 重量保持不变。',
  ...
  '{0} rows skipped — no exercise name.': '跳过 {0} 行——没有动作名称。',
  '{0} rows skipped — no date.': '跳过 {0} 行——没有日期。',
  '{0} rows skipped — no weight, reps, distance or time.': '跳过 {0} 行——没有重量、次数、距离或时间。',
  'Match to a library exercise': '对应到动作库中的动作',
  'Match to “{0}”?': '对应到“{0}”？',
  ...
  'Three working sets at a percentage of your training max: a week of 5s, a week of 3s, a 5/3/1 week, then a light week. Hit the heavy week and the max goes up.': '三组正式组按训练最大重量的百分比来：一周 5 次，一周 3 次，一周 5/3/1，然后是轻松周。完成大重量周后，最大重量上调。',
  'Week {0} of 4 — {1}% / {2}% / {3}% of a {4} {5} training max.': '第 {0} 周，共 4 周 — 训练最大重量 {4} {5} 的 {1}% / {2}% / {3}%。',
  ...
  "The phone keeps its own log": "手机保留自己的记录",
  "Newest edit wins per workout day, and a day is never deleted silently.": "每个训练日以最新的编辑为准，某一天绝不会被悄悄删除。",
  "Server address": "服务器地址",
  "Sync token": "同步令牌",
  "Sync to my openGym": "同步到我的 openGym",
  "Synced with your openGym": "已与你的 openGym 同步",
  "Could not reach the server — the phone keeps its own log.": "无法连接服务器 — 手机保留自己的记录。",
  "Stop syncing": "停止同步",
  "The log stays on this phone.": "记录留在这台手机上。",
  "Sync stopped — the log stays on this phone.": "已停止同步 — 记录留在这台手机上。",
  "Sync token for the phone": "给手机的同步令牌",
  "Sync token copied — paste it into the phone.": "同步令牌已复制 — 粘贴到手机上。",
  "Could not create a sync token.": "无法创建同步令牌。",
  "Enter the server address and the sync token.": "请输入服务器地址和同步令牌。",
  "Add another passkey": "再添加一个通行密钥",
  "A second phone can sign in if you lose this one.": "如果弄丢这台手机，另一台手机仍可登录。",
  "Passkey added": "已添加通行密钥",
  "Could not add a passkey.": "无法添加通行密钥。",
  "Measurements": "围度",
  "Waist": "腰围",
  "Arm": "臂围",
  "Hips": "臀围",
