...
export default {
  ...
  'Choose a starter plan': 'स्टार्टर प्लान चुनें',
  'Push / Pull / Legs': 'पुश / पुल / लेग्स',
  'Mon Push · Wed Pull · Fri Legs': 'सोम पुश · बुध पुल · शुक्र लेग्स',
  'Upper / lower': 'अपर / लोअर',
  'Mon and Thu upper · Tue and Fri lower': 'सोम और गुरु अपर · मंगल और शुक्र लोअर',
  'Starter plan loaded — Mon and Thu upper · Tue and Fri lower': 'स्टार्टर प्लान लोड हो गया — सोम और गुरु अपर · मंगल और शुक्र लोअर',
  'Full body': 'फुल बॉडी',
  'Mon, Wed and Fri, a different session each day': 'सोम, बुध और शुक्र, हर दिन अलग सेशन',
  'Starter plan loaded — Mon, Wed and Fri full body': 'स्टार्टर प्लान लोड हो गया — सोम, बुध और शुक्र फुल बॉडी',
  '5×5': '5×5',
  'Squat, bench and row; then squat, press and deadlift. Mon A · Wed B · Fri A.': 'स्क्वाट, बेंच और रो; फिर स्क्वाट, प्रेस और डेडलिफ्ट। सोम A · बुध B · शुक्र A.',
  'Starter plan loaded — Mon and Fri workout A · Wed workout B': 'स्टार्टर प्लान लोड हो गया — सोम और शुक्र वर्कआउट A · बुध वर्कआउट B',
  'Reps left in reserve — {0} {1} more.': 'रेप्स बचे हुए हैं — {0} {1} और।',
  'Every rep, but the last set was a grind — same weight again.': 'हर रेप हो गया, लेकिन आखिरी सेट मुश्किल था — वही वज़न फिर से।',
  ...
  '{0} rows skipped — no exercise name.': '{0} पंक्तियाँ छोड़ी गईं — व्यायाम का नाम नहीं।',
  '{0} rows skipped — no date.': '{0} पंक्तियाँ छोड़ी गईं — तारीख नहीं।',
  '{0} rows skipped — no weight, reps, distance or time.': '{0} पंक्तियाँ छोड़ी गईं — वज़न, रेप्स, दूरी या समय नहीं।',
  'Match to a library exercise': 'लाइब्रेरी के व्यायाम से मिलाएँ',
  'Match to “{0}”?': '"{0}" से मिलाएँ?',
  ...
  'Three working sets at a percentage of your training max: a week of 5s, a week of 3s, a 5/3/1 week, then a light week. Hit the heavy week and the max goes up.': 'ट्रेनिंग मैक्स के प्रतिशत पर तीन वर्किंग सेट: 5 की हफ्ता, 3 की हफ्ता, 5/3/1 हफ्ता, फिर हल्का हफ्ता। भारी हफ्ता पूरा हो तो मैक्स बढ़ता है।',
  'Week {0} of 4 — {1}% / {2}% / {3}% of a {4} {5} training max.': '4 में से हफ्ता {0} — {4} {5} ट्रेनिंग मैक्स का {1}% / {2}% / {3}%.',
  ...
  "The phone keeps its own log": "फ़ोन अपनी लॉग रखता है",
  "Newest edit wins per workout day, and a day is never deleted silently.": "हर कसरत वाले दिन सबसे नया बदलाव जीतता है, और कोई दिन चुपचाप नहीं मिटता।",
  "Server address": "सर्वर पता",
  "Sync token": "सिंक टोकन",
  "Sync to my openGym": "मेरे openGym से सिंक करें",
  "Synced with your openGym": "आपके openGym से सिंक हो गया",
  "Could not reach the server — the phone keeps its own log.": "सर्वर तक नहीं पहुँच सके — फ़ोन अपनी लॉग रखता है।",
  "Stop syncing": "सिंक रोकें",
  "The log stays on this phone.": "लॉग इसी फ़ोन पर रहती है।",
  "Sync stopped — the log stays on this phone.": "सिंक रुक गया — लॉग इसी फ़ोन पर रहती है।",
  "Sync token for the phone": "फ़ोन के लिए सिंक टोकन",
  "Sync token copied — paste it into the phone.": "टोकन कॉपी हो गया — इसे फ़ोन में चिपकाएँ।",
  "Could not create a sync token.": "सिंक टोकन नहीं बन सका।",
  "Enter the server address and the sync token.": "सर्वर पता और सिंक टोकन दर्ज करें।",
  "Add another passkey": "एक और पासकी जोड़ें",
  "A second phone can sign in if you lose this one.": "अगर यह फ़ोन खो जाए तो दूसरा फ़ोन साइन इन कर सकता है।",
  "Passkey added": "पासकी जुड़ गई",
  "Could not add a passkey.": "पासकी नहीं जुड़ सकी।",
  "Measurements": "माप",
  "Waist": "कमर",
  "Arm": "बाँह",
  "Hips": "कूल्हे",
