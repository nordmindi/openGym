...
export default {
  ...
  'Choose a starter plan': 'Выбери стартовый план',
  'Push / Pull / Legs': 'Push / Pull / Ноги',
  'Mon Push · Wed Pull · Fri Legs': 'Пн Push · Ср Pull · Пт Ноги',
  'Upper / lower': 'Верх / низ',
  'Mon and Thu upper · Tue and Fri lower': 'Пн и чт верх · Вт и пт низ',
  'Starter plan loaded — Mon and Thu upper · Tue and Fri lower': 'Стартовый план загружен — Пн и чт верх · Вт и пт низ',
  'Full body': 'Всё тело',
  'Mon, Wed and Fri, a different session each day': 'Пн, ср и пт, каждый день другая тренировка',
  'Starter plan loaded — Mon, Wed and Fri full body': 'Стартовый план загружен — Пн, ср и пт всё тело',
  '5×5': '5×5',
  'Squat, bench and row; then squat, press and deadlift. Mon A · Wed B · Fri A.': 'Присед, жим и тяга; затем присед, жим стоя и становая. Пн A · Ср B · Пт A.',
  'Starter plan loaded — Mon and Fri workout A · Wed workout B': 'Стартовый план загружен — Пн и пт тренировка A · Ср тренировка B',
  'Reps left in reserve — {0} {1} more.': 'Повторения в запасе — ещё {0} {1}.',
  'Every rep, but the last set was a grind — same weight again.': 'Все повторения есть, но последний подход был на пределе — тот же вес ещё раз.',
  ...
  '{0} rows skipped — no exercise name.': '{0} строк пропущено — нет названия упражнения.',
  '{0} rows skipped — no date.': '{0} строк пропущено — нет даты.',
  '{0} rows skipped — no weight, reps, distance or time.': '{0} строк пропущено — нет веса, повторов, дистанции или времени.',
  'Match to a library exercise': 'Сопоставить с упражнением из библиотеки',
  'Match to “{0}”?': 'Сопоставить с «{0}»?',
  ...
  'Three working sets at a percentage of your training max: a week of 5s, a week of 3s, a 5/3/1 week, then a light week. Hit the heavy week and the max goes up.': 'Три рабочих подхода в процентах от тренировочного максимума: неделя пятёрок, неделя троек, неделя 5/3/1, затем лёгкая неделя. Тяжёлая неделя выполнена — максимум растёт.',
  'Week {0} of 4 — {1}% / {2}% / {3}% of a {4} {5} training max.': 'Неделя {0} из 4 — {1}% / {2}% / {3}% от тренировочного максимума {4} {5}.',
  ...
  "The phone keeps its own log": "Телефон хранит свой журнал",
  "Newest edit wins per workout day, and a day is never deleted silently.": "Для каждого тренировочного дня побеждает более новая правка, и день никогда не удаляется молча.",
  "Server address": "Адрес сервера",
  "Sync token": "Токен синхронизации",
  "Sync to my openGym": "Синхронизировать с моим openGym",
  "Synced with your openGym": "Синхронизировано с вашим openGym",
  "Could not reach the server — the phone keeps its own log.": "Сервер недоступен — телефон хранит свой журнал.",
  "Stop syncing": "Остановить синхронизацию",
  "The log stays on this phone.": "Журнал остаётся на этом телефоне.",
  "Sync stopped — the log stays on this phone.": "Синхронизация остановлена — журнал остаётся на этом телефоне.",
  "Sync token for the phone": "Токен синхронизации для телефона",
  "Sync token copied — paste it into the phone.": "Токен скопирован — вставьте его на телефоне.",
  "Could not create a sync token.": "Не удалось создать токен синхронизации.",
  "Enter the server address and the sync token.": "Введите адрес сервера и токен синхронизации.",
  "Add another passkey": "Добавить ещё один ключ доступа",
  "A second phone can sign in if you lose this one.": "Второй телефон сможет войти, если потеряете этот.",
  "Passkey added": "Ключ доступа добавлен",
  "Could not add a passkey.": "Не удалось добавить ключ доступа.",
}
