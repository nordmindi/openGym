...
export default {
  ...
  'Choose a starter plan': 'Elige un plan inicial',
  'Push / Pull / Legs': 'Push / Pull / Piernas',
  'Mon Push · Wed Pull · Fri Legs': 'Lun Push · Mié Pull · Vie Piernas',
  'Upper / lower': 'Superior / inferior',
  'Mon and Thu upper · Tue and Fri lower': 'Lun y jue superior · Mar y vie inferior',
  'Starter plan loaded — Mon and Thu upper · Tue and Fri lower': 'Plan inicial cargado — Lun y jue superior · Mar y vie inferior',
  'Full body': 'Cuerpo completo',
  'Mon, Wed and Fri, a different session each day': 'Lun, mié y vie, una sesión distinta cada día',
  'Starter plan loaded — Mon, Wed and Fri full body': 'Plan inicial cargado — Lun, mié y vie cuerpo completo',
  '5×5': '5×5',
  'Squat, bench and row; then squat, press and deadlift. Mon A · Wed B · Fri A.': 'Sentadilla, press y remo; luego sentadilla, press militar y peso muerto. Lun A · Mié B · Vie A.',
  'Starter plan loaded — Mon and Fri workout A · Wed workout B': 'Plan inicial cargado — Lun y vie entreno A · Mié entreno B',
  'Reps left in reserve — {0} {1} more.': 'Repeticiones en reserva — {0} {1} más.',
  'Every rep, but the last set was a grind — same weight again.': 'Todas las repeticiones, pero la última serie fue al límite — el mismo peso otra vez.',
  ...
  '{0} rows skipped — no exercise name.': '{0} filas omitidas — sin nombre de ejercicio.',
  '{0} rows skipped — no date.': '{0} filas omitidas — sin fecha.',
  '{0} rows skipped — no weight, reps, distance or time.': '{0} filas omitidas — sin peso, reps, distancia ni tiempo.',
  'Match to a library exercise': 'Asignar a un ejercicio de la biblioteca',
  'Match to “{0}”?': '¿Asignar a «{0}»?',
  'Every set logged as “{0}” becomes {1}. The next import of that name follows.': 'Cada serie registrada como «{0}» pasa a ser {1}. La próxima importación de ese nombre sigue.',
  'Match': 'Asignar',
  'Matched to {0}': 'Asignado a {0}',
  'Bar': 'Barra',
  'The plates below are for each side of this bar.': 'Los discos son para cada lado de esta barra.',
  '{0} bar · {1} each side': 'Barra de {0} · {1} por lado',
  '{0} bar · empty': 'Barra de {0} · vacía',
  'Under a {0} bar': 'Por debajo de una barra de {0}',
  '{0} left over': 'Sobran {0}',
  'Note for this exercise': 'Nota para este ejercicio',
  'Warm-up': 'Calentamiento',
  'Next: {0}': 'Siguiente: {0}',
  'Working set': 'Serie efectiva',
  // --- mobile build ---
  'Your data': 'Tus datos',
  ...
  'Three working sets at a percentage of your training max: a week of 5s, a week of 3s, a 5/3/1 week, then a light week. Hit the heavy week and the max goes up.': 'Tres series de trabajo a un porcentaje de tu máximo de entrenamiento: una semana de 5, una de 3, una de 5/3/1 y luego una semana ligera. Si completas la semana pesada, el máximo sube.',
  'Week {0} of 4 — {1}% / {2}% / {3}% of a {4} {5} training max.': 'Semana {0} de 4 — {1} % / {2} % / {3} % de un máximo de entrenamiento de {4} {5}.',
  ...
  "The phone keeps its own log": "El teléfono guarda su propio registro",
  "Newest edit wins per workout day, and a day is never deleted silently.": "La edición más reciente gana por día de entrenamiento, y un día nunca se borra en silencio.",
  "Server address": "Dirección del servidor",
  "Sync token": "Token de sincronización",
  "Sync to my openGym": "Sincronizar con mi openGym",
  "Synced with your openGym": "Sincronizado con tu openGym",
  "Could not reach the server — the phone keeps its own log.": "No se pudo alcanzar el servidor — el teléfono guarda su propio registro.",
  "Stop syncing": "Dejar de sincronizar",
  "The log stays on this phone.": "El registro se queda en este teléfono.",
  "Sync stopped — the log stays on this phone.": "Sincronización detenida — el registro se queda en este teléfono.",
  "Sync token for the phone": "Token de sincronización para el teléfono",
  "Sync token copied — paste it into the phone.": "Token copiado — pégalo en el teléfono.",
  "Could not create a sync token.": "No se pudo crear un token de sincronización.",
  "Enter the server address and the sync token.": "Introduce la dirección del servidor y el token de sincronización.",
  "Add another passkey": "Añadir otra passkey",
  "A second phone can sign in if you lose this one.": "Un segundo teléfono puede entrar si pierdes este.",
  "Passkey added": "Passkey añadida",
  "Could not add a passkey.": "No se pudo añadir una passkey.",
}
