...
export default {
  ...
  'Choose a starter plan': 'Bir başlangıç planı seç',
  'Push / Pull / Legs': 'Push / Pull / Bacak',
  'Mon Push · Wed Pull · Fri Legs': 'Pzt Push · Çar Pull · Cum Bacak',
  'Upper / lower': 'Üst / alt vücut',
  'Mon and Thu upper · Tue and Fri lower': 'Pzt ve Per üst · Sal ve Cum alt',
  'Starter plan loaded — Mon and Thu upper · Tue and Fri lower': 'Başlangıç planı yüklendi — Pzt ve Per üst · Sal ve Cum alt',
  'Full body': 'Tüm vücut',
  'Mon, Wed and Fri, a different session each day': 'Pzt, Çar ve Cum, her gün farklı bir seans',
  'Starter plan loaded — Mon, Wed and Fri full body': 'Başlangıç planı yüklendi — Pzt, Çar ve Cum tüm vücut',
  '5×5': '5×5',
  'Squat, bench and row; then squat, press and deadlift. Mon A · Wed B · Fri A.': 'Squat, bench ve row; sonra squat, press ve deadlift. Pzt A · Çar B · Cum A.',
  'Starter plan loaded — Mon and Fri workout A · Wed workout B': 'Başlangıç planı yüklendi — Pzt ve Cum antrenman A · Çar antrenman B',
  'Reps left in reserve — {0} {1} more.': 'Yedekte tekrar var — {0} {1} daha.',
  'Every rep, but the last set was a grind — same weight again.': 'Tüm tekrarlar tamam, ama son set zordu — aynı ağırlık bir kez daha.',
  ...
  '{0} rows skipped — no exercise name.': '{0} satır atlandı — egzersiz adı yok.',
  '{0} rows skipped — no date.': '{0} satır atlandı — tarih yok.',
  '{0} rows skipped — no weight, reps, distance or time.': '{0} satır atlandı — ağırlık, tekrar, mesafe veya süre yok.',
  'Match to a library exercise': 'Kütüphanedeki bir harekete eşle',
  'Match to “{0}”?': '“{0}” ile eşlensin mi?',
  ...
  'Three working sets at a percentage of your training max: a week of 5s, a week of 3s, a 5/3/1 week, then a light week. Hit the heavy week and the max goes up.': 'Antrenman maksimumunun yüzdesiyle üç çalışma seti: bir hafta 5’ler, bir hafta 3’ler, bir 5/3/1 haftası, sonra hafif bir hafta. Ağır haftayı tutturursan maksimum artar.',
  'Week {0} of 4 — {1}% / {2}% / {3}% of a {4} {5} training max.': '4 haftanın {0}. haftası — {4} {5} antrenman maksimumunun %{1} / %{2} / %{3}’ü.',
  ...
  "The phone keeps its own log": "Telefon kendi kaydını tutar",
  "Newest edit wins per workout day, and a day is never deleted silently.": "Her antrenman gününde en yeni düzenleme kazanır ve bir gün sessizce silinmez.",
  "Server address": "Sunucu adresi",
  "Sync token": "Eşitleme anahtarı",
  "Sync to my openGym": "openGym hesabımla eşitle",
  "Synced with your openGym": "openGym hesabınla eşitlendi",
  "Could not reach the server — the phone keeps its own log.": "Sunucuya ulaşılamadı — telefon kendi kaydını tutar.",
  "Stop syncing": "Eşitlemeyi durdur",
  "The log stays on this phone.": "Kayıt bu telefonda kalır.",
  "Sync stopped — the log stays on this phone.": "Eşitleme durdu — kayıt bu telefonda kalır.",
  "Sync token for the phone": "Telefon için eşitleme anahtarı",
  "Sync token copied — paste it into the phone.": "Anahtar kopyalandı — telefona yapıştır.",
  "Could not create a sync token.": "Eşitleme anahtarı oluşturulamadı.",
  "Enter the server address and the sync token.": "Sunucu adresini ve eşitleme anahtarını gir.",
  "Add another passkey": "Başka bir geçiş anahtarı ekle",
  "A second phone can sign in if you lose this one.": "Bunu kaybedersen ikinci bir telefon giriş yapabilir.",
  "Passkey added": "Geçiş anahtarı eklendi",
  "Could not add a passkey.": "Geçiş anahtarı eklenemedi.",
